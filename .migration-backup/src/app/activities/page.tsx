      ...
      <header className="flex justify-between items-center">
        <div className="space-y-1">
          ...
          <p className="text-stone-500 font-medium">
            Defining your "Spike"—the unique value you bring to campus.
          </p>
        </div>
        <button
      ...
      {isAdding && (
        ...
        >
          <div className="flex justify-between items-center mb-4">
            <h3 className="font-black text-stone-800 uppercase tracking-widest text-sm">
              New Activity
            </h3>
            <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <select
                ...
                onChange={(e) =>
                  setNewActivity({ ...newActivity, impact: e.target.value })
                }
        ...
        {activities.length === 0 ? (
          <div className="col-span-2 text-center py-20 neu-flat space-y-4">
            ...
            <p className="text-stone-400 font-medium">
              Your profile is a blank slate. Start adding your achievements!
            </p>
          </div>
        ) : (
