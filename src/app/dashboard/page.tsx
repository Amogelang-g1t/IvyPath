...
import { Target, FileText, Trophy, GraduationCap, DollarSign, Mic, ArrowRight, Sparkles, Quote, ChevronRight, Upload } from 'lucide-react';
      ...
      <div className="neu-flat bg-stone-900 text-white border-0 shadow-xl overflow-hidden">
        <div className="p-6 flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-white/60 text-sm">— {randomQuote.author}</p>
          </div >
        </div >
      </div >
