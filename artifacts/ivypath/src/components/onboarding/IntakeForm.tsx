    ...
    <div className="max-w-2xl mx-auto space-y-10 py-10 px-4">
      ...
      <div className="grid grid-cols-1 gap-8">
        ...
        <div className="space-y-4">
          <label className="text-xs font-semibold text-[var(--ivy-text-muted)] uppercase tracking-[0.08em] block">Gender</label>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <select
                ...
                className="input-field text-sm appearance-none w-full pr-10 bg-[var(--ivy-bg-elevated)] text-[var(--ivy-text-primary)]"
                style={{ backgroundColor: 'var(--ivy-bg-elevated)' }}
              >
                <option value="" className="bg-[var(--ivy-bg-elevated)] text-[var(--ivy-text-primary)]">Select Province</option>
                {PROVINCES.map(p => (
                  <option key={p.value} value={p.value} className="bg-[var(--ivy-bg-elevated)] text-[var(--ivy-text-primary)]">
                    {p.label}
                  </option>
                ))}
              </select>
              <div className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 text-[var(--ivy-accent)]">
